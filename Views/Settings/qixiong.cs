...
public class QiXiongPage : SettingsPageBase
{
    ...
    private void InitializeComponent()
    {
        ...
        AddSection(panel, "简介", 20, FontWeight.Bold, ThemeHelper.GetLightBlueBrush());
        AddParagraph(panel, "");
        ...
        AddSection(panel, "发展历程", 20, FontWeight.Bold, ThemeHelper.GetLightBlueBrush());
        AddParagraph(panel, "");
        ...
        AddSection(panel, "基本特征", 20, FontWeight.Bold, ThemeHelper.GetLightBlueBrush());
        AddParagraph(panel, "");
        ...
        AddSection(panel, "特色", 20, FontWeight.Bold, ThemeHelper.GetLightBlueBrush());
        AddParagraph(panel, "");
        ...
        AddSection(panel, "历史背景", 18, FontWeight.Bold, ThemeHelper.GetTextBrush());
        AddParagraph(panel, "");
        ...
        AddSection(panel, "一片式齐胸襦裙穿法步骤", 20, FontWeight.Bold, ThemeHelper.GetLightBlueBrush());
        AddParagraph(panel, "");
