...
public class DayYiJiSettingsControl : ComponentBase<DayYiJiSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        FluentAvaloniaCompatibilityHelper.SetInfoBarProperty(disclaimerBar, "Message", "我们是坚定不移的唯物主义者，世界是物质的，不依赖于我们的意识（更不依赖于ClassIsland）。宜忌内容仅供参考，切勿当真。");
    ...
    private Grid CreateStyleTable()
    {
        ...
        AddTableCell(grid, 1, 1, CreateSizeCell(out _yiLabelFontSizeNumericUpDown, out _yiLabelEnableCustomFontSizeToggle, OnYiLabelFontSizeChanged, OnYiLabelEnableCustomFontSizeChanged));
        AddTableCell(grid, 1, 2, CreateColorCell(out _yiLabelFontColorPicker, out _yiLabelEnableCustomFontColorToggle, OnYiLabelColorChanged, OnYiLabelEnableCustomFontColorChanged));
        AddTableCell(grid, 1, 3, CreateFamilyCell(out _yiLabelFontFamilyComboBox, out _yiLabelEnableCustomFontFamilyToggle, OnYiLabelFontFamilyChanged, OnYiLabelEnableCustomFontFamilyChanged));
        AddTableCell(grid, 1, 4, CreateWeightCell(out _yiLabelFontWeightComboBox, out _yiLabelEnableCustomFontWeightToggle, OnYiLabelFontWeightChanged, OnYiLabelEnableCustomFontWeightChanged));

        // 宜值（颜色固定为绿色）
        AddTableRowLabel(grid, 2, "宜值");
        AddTableCell(grid, 2, 1, CreateSizeCell(out _yiValueFontSizeNumericUpDown, out _yiValueEnableCustomFontSizeToggle, OnYiValueFontSizeChanged, OnYiValueEnableCustomFontSizeChanged));
        AddTableCell(grid, 2, 2, CreateFixedColorHint("固定绿色"));
        AddTableCell(grid, 2, 3, CreateFamilyCell(out _yiValueFontFamilyComboBox, out _yiValueEnableCustomFontFamilyToggle, OnYiValueFontFamilyChanged, OnYiValueEnableCustomFontFamilyChanged));
        AddTableCell(grid, 2, 4, CreateWeightCell(out _yiValueFontWeightComboBox, out _yiValueEnableCustomFontWeightToggle, OnYiValueFontWeightChanged, OnYiValueEnableCustomFontWeightChanged));

        // 忌标签
        AddTableRowLabel(grid, 3, "忌标签");
        AddTableCell(grid, 3, 1, CreateSizeCell(out _jiLabelFontSizeNumericUpDown, out _jiLabelEnableCustomFontSizeToggle, OnJiLabelFontSizeChanged, OnJiLabelEnableCustomFontSizeChanged));
        AddTableCell(grid, 3, 2, CreateColorCell(out _jiLabelFontColorPicker, out _jiLabelEnableCustomFontColorToggle, OnJiLabelColorChanged, OnJiLabelEnableCustomFontColorChanged));
        AddTableCell(grid, 3, 3, CreateFamilyCell(out _jiLabelFontFamilyComboBox, out _jiLabelEnableCustomFontFamilyToggle, OnJiLabelFontFamilyChanged, OnJiLabelEnableCustomFontFamilyChanged));
        AddTableCell(grid, 3, 4, CreateWeightCell(out _jiLabelFontWeightComboBox, out _jiLabelEnableCustomFontWeightToggle, OnJiLabelFontWeightChanged, OnJiLabelEnableCustomFontWeightChanged));

        // 忌值（颜色固定为红色）
        AddTableRowLabel(grid, 4, "忌值");
        AddTableCell(grid, 4, 1, CreateSizeCell(out _jiValueFontSizeNumericUpDown, out _jiValueEnableCustomFontSizeToggle, OnJiValueFontSizeChanged, OnJiValueEnableCustomFontSizeChanged));
        AddTableCell(grid, 4, 2, CreateFixedColorHint("固定红色"));
        AddTableCell(grid, 4, 3, CreateFamilyCell(out _jiValueFontFamilyComboBox, out _jiValueEnableCustomFontFamilyToggle, OnJiValueFontFamilyChanged, OnJiValueEnableCustomFontFamilyChanged));
        AddTableCell(grid, 4, 4, CreateWeightCell(out _jiValueFontWeightComboBox, out _jiValueEnableCustomFontWeightToggle, OnJiValueFontWeightChanged, OnJiValueEnableCustomFontWeightChanged));
