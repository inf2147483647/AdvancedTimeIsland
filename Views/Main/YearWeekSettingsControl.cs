...
public class YearWeekSettingsControl : ComponentBase<YearWeekSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        // ==================== 周数设置 ====================
        var weekPanel = new StackPanel { Orientation = Orientation.Vertical, Spacing = 6 };
        ...
        weekPanel.Children.Add(firstDayRow);

        sp.Children.Add(SettingsGroupFactory.Create("周数设置", weekPanel));
