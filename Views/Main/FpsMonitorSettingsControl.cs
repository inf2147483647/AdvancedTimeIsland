...
public class FpsMonitorSettingsControl : ComponentBase<FpsMonitorSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        _valueColorNoteTextBlock = new TextBlock { Text = "颜色根据FPS自动变化（>=30绿色，20-30黄色，<20红色）", FontSize = 12, Foreground = ThemeHelper.GetSubTextBrush() };
    ...
    {
        var newLabelColor = ThemeHelper.GetThemeAwareTextColor();
    ...
    private void OnEnableComponentToggleChanged(object? sender, EventArgs e)
    {
        Settings.EnableComponent = _enableComponentToggle.IsChecked ?? false;
    }
