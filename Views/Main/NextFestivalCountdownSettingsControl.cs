...
public class NextFestivalCountdownSettingsControl : ComponentBase<NextFestivalCountdownSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        var festivalTypeTitle = new TextBlock { Text = "节日类型", FontSize = 14, FontWeight = FontWeight.Bold, Foreground = Brushes.White, Margin = new Thickness(0, 10, 0, 0) };
        sp.Children.Add(festivalTypeTitle);
        ...
        var nameTitle = new TextBlock { Text = "节日名样式", FontSize = 14, FontWeight = FontWeight.Bold, Foreground = Brushes.White, Margin = new Thickness(0, 10, 0, 0) };
