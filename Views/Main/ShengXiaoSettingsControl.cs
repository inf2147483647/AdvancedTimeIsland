...
public class ShengXiaoSettingsControl : ComponentBase<ShengXiaoSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        var contentPanel = new StackPanel { Orientation = Orientation.Vertical, Spacing = 6 };
        ...
        contentPanel.Children.Add(tableScroll);
        contentPanel.Children.Add(CreateFontWeightHintTextBlock());

        // ==================== 文案设置（表格） ====================
        sp.Children.Add(SettingsGroupFactory.Create("文案设置", contentPanel));
