...
public class NextJieQiCountdownSettingsControl : ComponentBase<NextJieQiCountdownSettings>
{
    ...
    public NextJieQiCountdownSettingsControl() { InitializeComponent(); }
    ...
    private void InitializeComponent()
    {
        ...
        var appearanceGroup = new Expander { Header = _appearanceGroupHeader, IsExpanded = true, Margin = new Thickness(0, 10, 0, 0) };
