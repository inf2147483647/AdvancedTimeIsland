...
public class FestivalSettingsControl : ComponentBase<FestivalSettings>
{
    ...
    private void InitializeComponent()
    {
        ...
        var festivalTypePanel = new StackPanel { Orientation = Orientation.Vertical, Spacing = 6 };
        ...
        festivalTypePanel.Children.Add(_internationalToggle);
        ...
        festivalTypePanel.Children.Add(_traditionalToggle);
        ...
        festivalTypePanel.Children.Add(_redToggle);

        sp.Children.Add(SettingsGroupFactory.Create("节日类型", festivalTypePanel));
