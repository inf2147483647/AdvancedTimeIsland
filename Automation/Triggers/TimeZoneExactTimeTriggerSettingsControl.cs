...
public class TimeZoneExactTimeTriggerSettingsControl : TriggerSettingsControlBase<TimeZoneExactTimeRuleSettings>
{
    private ComboBox _timeZoneComboBox = null!;
    private DatePicker _startDatePicker = null!;
    private TimePicker _startTimePicker = null!;

    public TimeZoneExactTimeTriggerSettingsControl()
    {
        InitializeComponent();
        Loaded += OnLoaded;
    }
