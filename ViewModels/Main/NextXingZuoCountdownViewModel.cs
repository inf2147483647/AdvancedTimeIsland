...
public class NextXingZuoCountdownViewModel : INotifyPropertyChanged, IDisposable
{
    ...
    private void OnSettingsChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        if (e.PropertyName == nameof(NextXingZuoCountdownSettings.TimeFormat) || e.PropertyName == nameof(NextXingZuoCountdownSettings.Text1) || e.PropertyName == nameof(NextXingZuoCountdownSettings.Text3) || e.PropertyName == nameof(NextXingZuoCountdownSettings.EnableSimpleMode) || e.PropertyName == nameof(NextXingZuoCountdownSettings.EnableTimeCorrection))
        {
            UpdateDisplay();
        }
    }
