...
[TriggerInfo("advancedtimeisland.daily_time_interval", "每天时间范围间隔触发", PackIconKind.TimerSync)]
public class DailyTimeIntervalTrigger : TimeTriggerBase<DailyTimeIntervalTriggerSettings>
{
