...
/// <summary>
/// 区时每月时间范围规则设置控件（带时区选择）
/// </summary>
public class TimeZoneMonthlyTimeRangeRuleSettingsControl : RuleSettingsControlBase<TimeZoneMonthlyTimeRangeRuleSettings>
{
    ...
    private StackPanel CreateDateTimePickerGroup(string label, bool isStart)
    {
        ...
        if (day > 0)
        {
            datePicker.SelectedDate = new DateTime(2024, 1, day);
        }
