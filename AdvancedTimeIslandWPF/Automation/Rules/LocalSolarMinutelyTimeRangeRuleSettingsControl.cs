...
public class LocalSolarMinutelyTimeRangeRuleSettingsControl : RuleSettingsControlBase<LocalSolarMinutelyTimeRangeRuleSettings>
{
    ...
    public LocalSolarMinutelyTimeRangeRuleSettingsControl() : this(null)
    {
    }

    public LocalSolarMinutelyTimeRangeRuleSettingsControl(PluginSettings? pluginSettings = null)
    {
