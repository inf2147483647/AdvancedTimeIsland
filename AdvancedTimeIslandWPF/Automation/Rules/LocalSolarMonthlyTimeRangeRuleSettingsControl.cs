...
/// <summary>
/// 地方时每月时间范围规则设置控件（带经度输入）
/// </summary>
public class LocalSolarMonthlyTimeRangeRuleSettingsControl : RuleSettingsControlBase<LocalSolarMonthlyTimeRangeRuleSettings>
{
    ...
    public LocalSolarMonthlyTimeRangeRuleSettingsControl() : this(null)
    {
    }

    public LocalSolarMonthlyTimeRangeRuleSettingsControl(PluginSettings? pluginSettings = null)
    {
    ...
    private void UpdateLongitudeDisplay()
    {
        ...
        _longitudeBox.Visibility = !isDms ? Visibility.Visible : Visibility.Collapsed;
