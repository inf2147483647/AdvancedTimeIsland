...
- [ ] 添加“时间范围内间隔触发”触发器(Trigger)，例如：在14:00-15:00之间每10分钟触发一次，支持精确时间，每年，每月，每天，每小时，每分钟，地方时的精确时间，每年，每月，每天，每小时，每分钟，区时的精确时间，每年，每月，每天，每小时，每分钟，农历的精确时间，每年，每月；添加到实验性功能，受“管理启用的功能”控制。<br>例如 精确时间范围间隔触发：<br>开始时间<br>[日期选择框年月日]<br>[时间选择框时分秒]<br>结束时间<br>[日期选择框年月日]<br>[时间选择框时分秒]<br>触发间隔<br>[输入框：输入实数][单位下拉框：秒，分，时，天，星期，月，年]；每年时间范围间隔触发：<br>开始时间<br>[日期选择框月日]<br>[时间选择框时分秒]<br>结束时间<br>[日期选择框月日]<br>[时间选择框时分秒]<br>触发间隔<br>[输入框：输入实数][单位下拉框：秒，分，时，天，星期，月，年]。注意：触发周期起始点为时间范围区间起点，不包含终点，确保每个触发时的时间减去时间范围区间起点时间为触发周期的整数倍。
- [ ] 使用BigInteger进行时间格式转换计算，彻底避免精度损失
