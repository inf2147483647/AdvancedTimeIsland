...
public class SemesterStartService : IHostedService
{
    ...
    /// <summary>
    /// 在 UI 线程触发学期开始日变化事件（WPF 版用 Dispatcher 取代 Avalonia 的 UIThread）。
    /// </summary>
    private static void RaiseSemesterStartDateChanged()
    {
        var handler = SemesterStartDateChanged;
